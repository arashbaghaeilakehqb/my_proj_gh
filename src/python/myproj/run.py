...
from myproj.pipeline import create_pipeline
...
# Configuration environment to be used for running the pipeline.
...
def init_context(proj_dir: str) -> Tuple[ConfigLoader,
    ...
    conf_creds = conf.get("credentials*", "credentials*/**")
    conf_params = conf.get("parameters*", "parameters*/**")

    logging.config.dictConfig(conf_logging)
    io = DataCatalog.from_config(conf_catalog, conf_creds)
